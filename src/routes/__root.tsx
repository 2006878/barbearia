    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          O caminho que você escolheu não existe por aqui.
        </p>
        <div className="mt-6">
          <Link
            to="/"
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          A página não carregou direito. Você pode tentar de novo ou voltar ao início.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Dama do Corte — Barbearia & Estúdio" },
      {
        name: "description",
        content:
          "Espaço de cuidado, autoestima e estilo em Passos/MG. Cortes, barba, tranças e sobrancelhas em um ambiente moderno, acolhedor e profissional.",
      },
      { name: "author", content: "Dama do Corte" },
      { name: "theme-color", content: "#111111" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { name: "apple-mobile-web-app-title", content: "Dama do Corte" },
      { property: "og:title", content: "Dama do Corte — Barbearia & Estúdio" },
      {
        property: "og:description",
        content:
          "Cortes, barba, tranças e sobrancelhas com técnica, respeito e estilo. Agende seu horário.",
      },
      { property: "og:type", content: "website" },
      { property: "og:locale", content: "pt_BR" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Dama do Corte — Barbearia & Estúdio" },
      {
